...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/regi_student.css" />
</head>
...
<body>
  ...
  <div class="col-md-5">
    <p align="center" style="color: white; font-family: 'Roboto Slab', serif; font-size: 30">
      <strong> Teacher Account Sign-up</strong>
    </p>
    <form action="includes/teacher_reg_process.php" method="POST">
      <div class="row">
        <div class="col-md-6">
          <p>First Name</p>
          <input class="int_txt" type="text" name="f_name" required pattern="[a-zA-Z]{}" /><br /><br />
          <p>Email</p>
          <input class="int_txt" type="email" name="email" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{3,}$" title="Please enter valid email" /><br /><br />
          <p>Password</p>
          <input class="int_txt" type="password" name="pass" required /><br />
        </div>
        <div class="col-md-6">
          <p>Last Name</p>
          <input class="int_txt" type="text" name="l_name" required pattern="[a-zA-Z]{}" /><br /><br />
          <p>Your Phone</p>
          <input class="int_txt" type="text" name="phone" required pattern="[0-9]{10}" title="Please Enter 10 Digits Phone Number" /><br /><br />
          <p>Conform Password</p>
          <input class="int_txt" type="password" name="c_pass" required /><br />
        </div>
      </div>
